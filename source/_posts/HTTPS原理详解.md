...
>HTTPS（全称：HyperText Transfer Protocol over Secure Socket Layer），其实 HTTPS 并不是一个新鲜协议，Google 很早就开始启用了，初衷是为了保证数据安全。 近两年，Google、Baidu、Facebook 等这样的互联网巨头，不谋而合地开始大力推行 HTTPS， 国内外的大型互联网公司很多也都已经启用了全站 HTTPS，这也是未来互联网发展的趋势。<!--more-->
...
## 详解
### 一、HTTP 访问过程
![我的头像](https://ooo.0o0.ooo/2017/06/18/5946217371888.png)

抓包如下：
![我的头像](https://ooo.0o0.ooo/2017/06/18/59461ed083a90.png)

如上图所示，HTTP请求过程中，客户端与服务器之间没有任何身份确认的过程，数据全部明文传输，“裸奔”在互联网上，所以很容易遭到黑客的攻击，如下：
![我的头像](https://ooo.0o0.ooo/2017/06/18/59461eef7e481.png)

可以看到，客户端发出的请求很容易被黑客截获，如果此时黑客冒充服务器，则其可返回任意信息给客户端，而不被客户端察觉，所以我们经常会听到一词“劫持”，现象如下：

下面两图中，浏览器中填入的是相同的URL，左边是正确响应，而右边则是被劫持后的响应
![我的头像](https://ooo.0o0.ooo/2017/06/18/59461f526e481.png)
...
![我的头像](https://ooo.0o0.ooo/2017/06/18/59461f614cafa.png)
...
![我的头像](https://ooo.0o0.ooo/2017/06/18/59461f6ee664e.png)
...
![我的头像](https://ooo.0o0.ooo/2017/06/18/59461f8686a15.png)
...
第四步：获取公钥与确认服务器身份
![](https://ooo.0o0.ooo/2017/06/18/59461f9e4ec17.png)
...
![](https://ooo.0o0.ooo/2017/06/18/59461fb91999b.png)
...
原文转自https://segmentfault.com/p/1210000009779379